...
function svg() {
   return gulp.src('./src/svg/**/*')
               ...
               .pipe(cheerio({
                  run: function ($) {
                     $('[fill="remove"]').removeAttr('fill').find('[fill]').removeAttr('fill');
                     $('[stroke="remove"]').removeAttr('stroke').find('[stroke]').removeAttr('stroke');
...
let build = gulp.series(
   clean, 
   gulp.parallel(styles, img, video, scripts, json, pug, html, fonts, svg)
)
